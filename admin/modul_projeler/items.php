...
?>
        ...
        <link rel="stylesheet" href="assets/plugins/magnific-popup/dist/magnific-popup.css"/>
                      ...
                      <div class="row">
                            <div class="col-sm-12">
                                <h4 class="page-title"><?=$cat_title;?> - Proje Resimleri</h4>
                                <ol class="breadcrumb">
                        	...
                        	<div class="col-lg-12">
                        		<div class="card-box">
                        			<div class="row">
			                        	...
			                        	<div class="col-sm-4">
			                        		 <a href="<?=$new_link;?>action=add" class="btn btn-default btn-md waves-effect waves-light m-b-30"><i class="md md-add"></i> Yeni Resim Ekle</a>
			                        	</div>
			                        </div>
