...
?>
                        ...
                        <div class="row">
                            <div class="col-sm-9">
                                ...
                                <p class="text-muted page-title-alt">3F Yapı İçerik Yönetim Sistemine Hoş Geldiniz!</p>
                            </div>
                            <div class="col-sm-3">
									...
									<div class="bar-widget">
										<div class="table-box">
                                            ...
                                            <div class="table-detail text-right">
                                                <span data-plugin="peity-pie" data-colors="#121864,#0c0f36"  data-width="50" data-height="45"><?=$c_tekil;?>/<?=$c_cogul;?></span>
                                            </div>
									...
									<div class="bar-widget">
										<div class="table-box">
											...
											<div class="table-detail">
											   ...
											   <p class="text-muted m-b-0 m-t-0">Bugünkü T/Ç Hit</p>
											</div>
                                            <div class="table-detail text-right">
                                                <span data-plugin="peity-donut" data-colors="#121864,#0c0f36" data-width="50" data-height="45"><?=$b_tekil;?>/<?=$b_cogul;?></span>
                                            </div>
