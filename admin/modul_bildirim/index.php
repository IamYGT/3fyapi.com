...
$page_name = "Bildirim Paneli";
$vt = "bildirim";
$apikey="AAAAlGajkcc:APA91bH8O7h3qm9U41Otldm_nPsivvwT92MbJOjQw6poWTMBHsxihJvj1QrO_JSQq2618QOGqAduoGL3vO172gnH4qrtPxvsxtQpRO_xohDz8CQYx7roNdpj-cJ0YcIEwhIQ4kHPvIvi";
$topic="3fyapi";
if($action == "row") {
...
$normal_kayit = array("text","textt", "textarea", "summernote", "tinymce", "clock", "color", "tags", "selectbox");
...
if($_POST) {
	...
	foreach($tablo as $sira => $rows){
		...
		if($rows["add"] == 1) {
		if(in_array($rows["type"], $normal_kayit) && $rows["type"]!="textt") {
			$vt_row[] = "?";
...
?>
	                                            <button type="submit" class="btn btn-success waves-effect waves-light">Bildirim Gönder</button>
	                                        </form>
                        				</div>                    				
                        			</div>
                        		</div>
                        	...
                        	<div class="col-lg-12">
                        		<div class="card-box">
                        			<div class="row">
			                        	...
			                        	<div class="col-sm-4">
			                        		 <a href="<?=$link;?>action=add" class="btn btn-default btn-md waves-effect waves-light m-b-30"><i class="md md-add"></i> Yeni Bildirim Gönder</a>
			                        	</div>
			                        </div>
...
<?php }} ?>
                                            ...
                                            <tbody id="sortable">
<?php
$bilgi= $db->VeriOkuCokluSorgu("SELECT * FROM " . $vt . $search . " ORDER BY id DESC");
$bilgial= $db->bilgial;
